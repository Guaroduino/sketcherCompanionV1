...
$path = "c:\Users\corad\OneDrive\Documentos\GitHub\sketcherCompanionV1\app\src\main\java\com\skecher\SketcherSurface.kt"
$lines = Get-Content $path

# Indices are 0-based.
# Keep 0..834 (Lines 1..835)
$part1 = $lines[0..834]

# Keep 1213..End (Lines 1214..End)
$part3 = $lines[1213..($lines.Count - 1)]

# Use Single-Quote Here-String to prevent Variable Expansion (Kotlin uses $)
$newLogic = @'
...
$finalContent = $part1 + @($newLogic) + $part3
