...
class PenTool(
    ...
    override fun toFreehandSettings(zoom: Float): FreehandSettings {
        ...
        return FreehandSettings(
            ...
            start = com.sketcher.sketchercompanionv1.dto.StrokeEndOptions(cap = true, taperEnabled = false),
            end = com.sketcher.sketchercompanionv1.dto.StrokeEndOptions(cap = true, taperEnabled = false),
            isComplete = false,
