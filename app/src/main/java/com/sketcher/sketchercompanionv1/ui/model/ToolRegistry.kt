...
object ToolRegistry {
    ...
    private val fullToolsList = listOf(
        ...
        StudioTool("stroke_type", Icons.Default.Gesture, "Tipo de Trazo", R.drawable.ic_tabler_stroke_type, isPlaceholder = false, subTools = listOf(
            StudioTool("stroke_freehand", Icons.Default.Gesture, "Mano Alzada", R.drawable.ic_tabler_stroke_freehand, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_line", Icons.Default.Timeline, "Línea", R.drawable.ic_tabler_stroke_line, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_circle", Icons.Default.RadioButtonUnchecked, "Círculo", R.drawable.ic_tabler_stroke_circle, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_polyline", Icons.Default.Polyline, "Polilínea", R.drawable.ic_tabler_stroke_polyline, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_arc", Icons.Default.Gesture, "Arco", R.drawable.ic_tabler_stroke_arc, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_ellipse", Icons.Default.Adjust, "Elipse", R.drawable.ic_tabler_stroke_ellipse, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_spline", Icons.Default.Gesture, "Spline", R.drawable.ic_tabler_stroke_spline, isPlaceholder = false, parentGroupId = "stroke_type"),
            StudioTool("stroke_bezier", Icons.Default.FormatShapes, "Bézier", R.drawable.ic_tabler_stroke_bezier, isPlaceholder = false, parentGroupId = "stroke_type")
        )),
