...
object ToolRegistry {
    val allTools = listOf(
        ...
        StudioTool("orto", Icons.Default.SquareFoot, "Ortho Mode", isPlaceholder = false),
        StudioTool("mirror", Icons.Default.Compare, "Mirror", isPlaceholder = false),
        StudioTool("mover_pt_pt", Icons.Default.OpenWith, "Move Point to Point", isPlaceholder = false),
        StudioTool("align_2_pt", Icons.Default.AlignHorizontalLeft, "Align 2 Points", isPlaceholder = false),
        StudioTool("offset", Icons.Default.CopyAll, "Offset", isPlaceholder = false),
        StudioTool("fillet", Icons.Default.RoundedCorner, "Fillet", isPlaceholder = false),
        StudioTool("chamfer", Icons.Default.Architecture, "Chamfer", isPlaceholder = false),
